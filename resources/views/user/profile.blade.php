...
<div class="container mt-lg-4 py-5 py-lg-5">
    ...
    <section class="card-columns">
        ...
        <div class="justify-content-center white align-items-center align-content-center d-none" id="no-more">
            <p class="text-center text-dark mb-0">No more records found.</p>
        </div>
    </section>
