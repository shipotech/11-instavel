                        ...
                        <div class="col-md-7 p-md-0">
                            ...
                            <div class="w-100 white">
                                <img class="card-img-top rounded-0 d-block"
                                     ...
                                     style="@if($image->user->image)height:{{ (\Intervention\Image\Facades\Image::make(asset('storage/images/' . $image->image_path) )->height() - 30) . 'px;' }}@else height: 400px;@endif">
                            </div>
                        </div>

                        <div class="col-md-5" style="@if($image->user->image)height:{{ (\Intervention\Image\Facades\Image::make(asset('storage/images/' . $image->image_path) )->height() - 30) . 'px;' }}@else height: 400px;@endif">
                            <div class="h-25">
                                <!-- Card content -->
